...
const ResumeFeedBack = () => {
    ...
    const {ats_score, recruiter_advice, strengths, weaknesses} = reportData.response;
                ...
                <div className="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2">
                    ...
                    >
                        <div className="flex flex-col items-center">
                            <h2 id="ats-score-section" className="text-center text-3xl sm:text-4xl font-semibold tracking-tight">
                                Your Score
                            </h2>
                        ...
                        <div className="mt-10">
                            ...
                            <ul className="list-decimal pl-6 space-y-2 marker:text-cyan-400">
                                {recruiter_advice.map((item, index) => (
                                    <li key={index} className="text-[1.05rem] leading-relaxed text-amber-50/90">
                                        {item}
                                    </li>
                                ))}
                            </ul>
