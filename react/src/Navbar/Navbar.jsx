...
const Navbar = () => {
  ...
  return (
    <div
      className={hostSwitch=="on"?"h-25 w-full bg-black flex justify-around items-center mb-5 opacity-25":"h-25 w-full bg-black flex justify-around items-center mb-5 opacity-100"}
    ...
    >
      ...
      <div className="flex gap-x-5">
        <div>
          <button
            className="h-12 w-35 flex justify-center items-center rounded-xl text-black font-bold gap-x-2"
      ...
      <div>
        <button
          className="h-12 w-30 flex justify-center items-center rounded-xl text-black font-bold"
          style={{ backgroundColor: "#2af6fd" }}
        >
          Sign In
        </button>
