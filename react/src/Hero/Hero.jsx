...
const Hero = () => {
  ...
  return (
    <div>
      <div
        className="h-125 w-full flex items-center p-10 justify-around"
        ...
        <div>
          ...
          <div className="h-80 w-full flex justify-center">
            <div className="h-80 w-110 rounded-2xl border-2 border-gray-300">
              <img src="../ai_mock_interview_image.png" alt="" className="h-60 w-110 rounded-t-2xl border-b-2 border-b-gray-300"></img>
              <div className="h-20 w-110 flex justify-around items-center">
                  <h1 className="text-xl font-semibold text-cyan-300">AI-Driven Mock Interview</h1>
                  <button className="h-10 w-25 rounded-xl bg-cyan-300 text-black font-semibold p-2">Start Test</button>
              </div> 
            </div>
          </div>
        </div>
